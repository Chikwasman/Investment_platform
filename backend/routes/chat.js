...
router.post('/session', async (req, res) => {
  try {
    ...
    if (!session) {
      ...
      await query(
        "INSERT INTO chat_messages (session_id, sender_type, sender_name, message) VALUES ($1, 'system', 'AtlasTitan Support', $2)",
        [session.id, `Hello ${displayName}! 👋 Welcome to AtlasTitan support. An agent will be with you shortly. In the meantime, feel free to describe your issue.`]
      );
    }
